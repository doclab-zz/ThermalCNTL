...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_ex_eml_block_call_stats_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ex_eml_block_call_stats_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_ex_eml_block_call_stats_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "ex_eml_block_call_stats") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ex_eml_block_call_stats_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
{
  extern unsigned int sf_ex_eml_block_call_stats_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "ex_eml_block_call_stats") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_ex_eml_block_call_stats_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_ex_eml_block_call_stats_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ex_eml_block_call_stats")) {
    return(sf_ex_eml_block_call_stats_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    ex_eml_block_call_stats_terminator();
    sf_debug_terminate();
  }
...
extern void ex_eml_block_call_stats_register_exported_symbols(SimStruct* S);
extern void ex_eml_block_call_stats_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ex_eml_block_call_stats_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      ex_eml_block_call_stats_debug_initialize();
    }

    ex_eml_block_call_stats_initializer();
  }
